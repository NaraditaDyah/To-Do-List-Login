...
<head>
    ...
    <link rel="preload" href="{{ asset('aurora.jpg') }}" as="image">
</head>

<body style="background-color: #06141d; margin: 0;" class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative bg-cover bg-center bg-no-repeat"
        style="background-image: url('{{ asset('aurora.jpg') }}'); background-color: #06141d;">
        ...
        <div class="relative z-10 w-full flex flex-col items-center">
            ...
            <div class="flex flex-col items-center mb-6 text-center">
                <a href="/">
                    <x-application-logo class="w-32 h-32 fill-current text-gray-200" />
                </a>
